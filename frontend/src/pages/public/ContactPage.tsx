...
const ContactPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setIsSubmitting(false);
      setSubmitError('Ocorreu um erro ao enviar sua mensagem. Por favor, tente novamente mais tarde ou entre em contato por telefone.');
    }
  };
      ...
      <section className="bg-[var(--primary)] text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl max-w-3xl">
            Estamos prontos para atender às suas necessidades. Entre em contato conosco para tirar dúvidas, 
            solicitar orçamentos ou agendar uma visita.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  ...
                  >
                    ...
                    <option value="convenio">Convênio de Condomínio</option>
            ...
            <div>
              ...
              <div className="bg-[var(--secondary)] p-6 rounded-lg shadow-md mb-8">
                ...
                <div className="flex items-start mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      contato@effe.com.br<br />
                      comercial@effe.com.br
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-[var(--secondary)] p-4 rounded-lg shadow-md">
                <h3 className="text-xl font-bold mb-4">Localização</h3>
                <div className="aspect-video bg-gray-300 rounded">
                  {/* Aqui seria inserido um mapa do Google Maps ou similar */}
